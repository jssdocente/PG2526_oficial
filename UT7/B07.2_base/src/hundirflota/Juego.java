...
public class Juego {
    ...
    public static void main(String[] args) {
        ...
        // humano.getMiTablero().colocarBarco(new Barco("Lancha", 1), new Coordenada(0,0), Direccion.ESTE);
        ...
        while (humano.tieneBarcosAFlote() && maquina.tieneBarcosAFlote()) {
            ...
            // EstadoCasilla resultado = turnoActual.getTableroRival().recibirDisparo(disparo);
