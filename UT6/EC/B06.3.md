# 🏆 Ejercicio B06.3: Liga de Fútbol Pro (Refactorización)

*Este ejercicio parte de la base del **EC06.3 Ejercicio 2 (La Quiniela 2.0)**, pero llevando la orientación a objetos a un nivel más profesional.*

## 📌 Contexto

En el ejercicio anterior, los equipos eran simples `Strings`. En una aplicación real, un equipo tiene más datos (código, estadio, plantilla...). Además, los partidos no están "sueltos", sino que se agrupan en **Jornadas**, y todas las jornadas forman una **Liga**.
...
> 💡 **Reflexión**: Fíjate cómo ahora la `Jornada` no sabe quiénes son los equipos hasta que se los pide a la `Liga`. Hemos separado las responsabilidades de forma clara.
